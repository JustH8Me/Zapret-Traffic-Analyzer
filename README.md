...
<img width="936" height="543" alt="изображение" src="https://github.com/user-attachments/assets/35caa395-0ad8-4daf-8649-2c39b9a2bd6b" />
...
### Как пользоваться:
1.  Запустить программу **от админа**.
2.  Написать название процесса (например, `r5apex.exe` или `НазваниеИгры.exe`).
3.  Нажми **СТАРТ**.
...
7.  Сохраненные списки из папки `zapret-lists` и вставляй их в свой батник Zapret.
...
* **Location / Provider** Используется  ip-api.com для распознования и поэтому присутствует **лимит** на запросы (в 45 запросов в минуту)

### Кол-во ИИ кода:
* **60-70% в дизайне (XAML)** я не силен в красивый интерфейс
* **остальной код 10% (регулярные вырожения и такая рутина)**
